      ...
      <FormControl as="form" onSubmit={handleSubmit}>
        <Card>
          <CardBody>
            ...
            <Input id="todoInput" type="text" name="todo" value={todos} onChange={(e) => setTodos(e.target.value)} placeholder="What do you want to do...." size="sm" required />
            <FormHelperText>Add your todo</FormHelperText>
            <Divider mt={2} />
            <FormLabel mt={'2'}>Add Todo's Description</FormLabel>
            <Input id="descriptionInput" type="text" name="description" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Description...." size="sm" required />
            <FormHelperText>Todo's Description</FormHelperText>
            <Divider mt={2} />
            <FormLabel mt={'2'}>Date</FormLabel>
            <Input type="date" name="date" value={date} onChange={(e) => setDate(e.target.value)} placeholder="Select date" size="sm" required />
